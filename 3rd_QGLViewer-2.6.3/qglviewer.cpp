...
void QGLViewer::drawAxis(qreal length)
{
	...
	// X
	float color[4];
	//color[0] = 1.0f;  color[1] = 0.3f;  color[2] = 0.3f;  color[3] = 1.0f;
	color[0] = 1.0f;  color[1] = 0.0f;  color[2] = 0.0f;  color[3] = 1.0f;
	glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, color);
	glPushMatrix();
	glRotatef(90.0, 0.0, 1.0, 0.0);
	QGLViewer::drawArrow(length, 0.03*length);
	glPopMatrix();

	// Y
	//color[0] = 0.3f;  color[1] = 1.0f;  color[2] = 0.3f;  color[3] = 1.0f;
	...
	// Z
	//color[0] = 0.3f;  color[1] = 0.3f;  color[2] = 1.0f;  color[3] = 1.0f;
