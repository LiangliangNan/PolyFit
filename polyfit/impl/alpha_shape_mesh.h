...
#ifndef POLYGONAL_SURFACE_RECONSTRUCTION_ALPHA_SHAPE_MESH_H
#define POLYGONAL_SURFACE_RECONSTRUCTION_ALPHA_SHAPE_MESH_H
...
#endif        // POLYGONAL_SURFACE_RECONSTRUCTION_ALPHA_SHAPE_MESH_H
